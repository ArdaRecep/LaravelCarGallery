            ...
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.car.store') }}">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col col-md-4">
                            <div class="form-group">
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        selectElement.style.color="#ffffffc5";
                            ...
                            <div class="image-container-wrapper">
                                <div class="form-group">
                                    ...
                                    <input class="form-control mb-3" type="file" id="file-upload" name="thumbnail"
                                        accept=".jpg, .jpeg, .png">
                                    <div class="d-flex align-items-center">
                                        <label for="file-upload">
                                            <img id="image" hidden style="width: 394px; height: 240px; padding:0px!important; border-color:#f5b754; object-fit: cover;" alt="Kapak Resmi"
                                                class="img-thumbnail">
                                        </label>
                                    </div>
                        ...
                        <div class="form-col col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex flex-column">
                                    <input class="form-control mb-2 s" type="file" id="images" name="images[]"
                        ...
                        <div class="form-col col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="fileInput" name="url" class="form-control mb-4"
                                    accept="video/mp4">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-outline-success rounded-pill" style="height: 50px; width: 200px;"><strong>Araba Ekle</strong></button>
                    </div>
                </form>
            </div>
        </div>
